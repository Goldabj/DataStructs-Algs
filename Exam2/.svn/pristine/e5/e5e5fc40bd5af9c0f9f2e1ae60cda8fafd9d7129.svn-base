...
public class SubtreeTest {
	...
	public void testMaxSubtreeHeightOfTwo() {
		BinaryTree b1 = new BinaryTree("ABCDE", "20200", new int[] { 5, -10, 6, 7, -4 });
	...
	public void testMaxSubtreeClearWinner() {
		BinaryTree b1 = new BinaryTree("ABCDEFGH", "L2200200", new int[] { -2, 3, -1, -2, -5, 10, -1, 5 });
		assertEquals("F14", b1.maxSubtree());

		BinaryTree b2 = new BinaryTree("ABCDEFGH", "L2200200", new int[] { 40, 3, -1, -2, -5, 10, -1, 5 });
	...
	public void testMaxSubtreeFewerChildren() {
		BinaryTree b1 = new BinaryTree("ABCDEF", "LRLLR0", new int[] { -10, 9, -8, 7, -6, 5 });
		assertEquals("B7", b1.maxSubtree());

		BinaryTree b2 = new BinaryTree("ABCEFGHD", "R2LR2000", new int[] { 1, 4, -20, 10, -3, 5, 4, -2 });
	...
	public void testMaxSubtreeOnTestPaper() {
		...
		BinaryTree b1 = new BinaryTree("MAXSUBTREes", "22200022000",
				new int[] { -30, 2, 6, 10, 3, 1, 10, 2, 50, -5, -15 });
		...
		BinaryTree b2 = new BinaryTree("MAXSUBTREes", "22200022000",
				new int[] { -30, 2, 6, 10, 3, 1, 10, 2, 21, -5, -15 });
		...
		BinaryTree b3 = new BinaryTree("MAXSUBTREes", "22200022000",
				new int[] { -14, 2, 6, 10, 3, 1, 10, 2, 50, -5, -15 });
		assertEquals("M50", b3.maxSubtree());
		maxSubtreePoints += 4;
	}

	@Test
	public void testMaxSubtreeLeftWinsTie() {
		BinaryTree b1 = new BinaryTree("ABCDE", "22000", new int[] { 5, 3, 2, 1, -5 });
		assertEquals("B6", b1.maxSubtree());
		maxSubtreePoints += 2;
	}

	@Test
	public void testMaxSubtreeRootWinsTie() {
		BinaryTree b1 = new BinaryTree("ABCDE", "20200", new int[] { 5, -5, 3, -1, 1 });
		b1.maxSubtree();
		assertEquals("A3", b1.maxSubtree());
		maxSubtreePoints += 2;
	}

	@Test
	public void testMaxSubtreeHeightOfFour() {
		BinaryTree b1 = new BinaryTree("ABCDEFGHIJKLMNOPQRSTUVWXYZa", "222002200200222002002200200", new int[] { 10, -5,
				-7, 2, -4, 3, -5, 2, 7, -6, 4, 1, 3, -2, -4, 7, 3, -5, 10, -13, 4, -5, 2, -2, 1, 2, -3 });
	...
	public void testSumSmall() {
		...
		sumPoints += 1;
		BinaryTree b2 = new BinaryTree("ABCD", "2L00", new int[] { -3, 6, 10, -5 });
	...
	public void testSumLarge() {
		BinaryTree b1 = new BinaryTree("ABCDEFGHIJKLMNOPQRSTUVWXYZa", "222002200200222002002200200", new int[] { 12, -5,
				-7, 2, -4, 3, -5, 2, 7, -6, 4, 1, 3, -2, -4, 7, 3, -5, 10, -13, 4, -5, 2, -2, 1, 2, -3 });
	...
	public static void displayPoints() {
		if (sumPoints > maxSubtreePoints) {
			System.out.printf("%2d/25 sum (simple version) points (5 = max since it is much easier)\n", sumPoints);
		} else {
			System.out.printf("%2d/25 maxSubtree correctness points\n", maxSubtreePoints);
			System.out.println("     ---maxSubtree efficiency points will be checked by instructor\n");
		}
