...
public class Triangle implements Comparable<Triangle> {
	...
	public double area() {
		...
		double semiperimeter = .5 * (this.a + this.b + this.c);
		double area = Math
				.sqrt(semiperimeter * (semiperimeter - this.a) * (semiperimeter - this.b) * (semiperimeter - this.c));
		return area;
	}
	...
	// compares trianlges based on their area. returns 1 if given triangle's
