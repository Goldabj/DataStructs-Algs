...
public class TaxicabNumberTests {
	...
	/**
	 * Test methods for
	 * {@link hardysTaxi.TaxicabNumber#TaxicabNumber(int, int, int, int, int)}.
	 */
	@Test
	...
	/**
	 * Test methods for
	 * {@link hardysTaxi.TaxicabNumber#equals(hardysTaxi.TaxicabNumber)}.
	 */
	@Test
	public void testEqualsTaxicabNumber_1() {
		assertTrue(new TaxicabNumber(1729, 12, 1, 9, 10).equals(new TaxicabNumber(1729, 9, 10, 12, 1)));
	}
	...
	public void testEqualsTaxicabNumber_2() {
		assertTrue(new TaxicabNumber(1729, 12, 1, 9, 10).equals(new TaxicabNumber(1729, 12, 1, 9, 10)));
	}
	...
	public void testEqualsTaxicabNumber_3() {
		assertTrue(new TaxicabNumber(1729, 12, 1, 9, 10).equals(new TaxicabNumber(1729, 10, 9, 1, 12)));
	}
