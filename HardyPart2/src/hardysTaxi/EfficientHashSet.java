 ...
 */
public class EfficientHashSet<E> extends AbstractSet<E> implements Serializable {
  ...
  public EfficientHashSet() {
    table = new Object[INITIAL_TABLE_SIZE];
  }

  public EfficientHashSet(Collection<? extends E> c) {
  ...
  /**
   * Works just like {@link #EfficientHashSet(Collection)}, but for arrays. Used to avoid
   * having to synthesize a collection in {@link Sets}.
   */
  EfficientHashSet(E[] c) {
    int newCapacity = INITIAL_TABLE_SIZE;
